...
main.function(data = "/Users/fatimardlb/Documents/master_bioinf/3_cuatri/analysis/data/aorticthoracic_aneurysm.txt",
              output.dir = "/Users/fatimardlb/Documents/master_bioinf/3_cuatri/analysis",
              header = TRUE,
              sep = "\t",
              dec = ".",
              remove.na = FALSE,
              ...
              FDR.name.col = "FDR",
              regulation = "all",
              ora = c("GO", "DISGENET", "KEGG", "PHENOTYPE"))
